            ...
            {room?.feedback ? (
              <div className="space-y-4 max-h-[60vh] overflow-auto no-scrollbar">
                {room.feedback.feedback && (
                  <div>
                    <h4 className="text-sm font-medium text-gray-600 mb-1">Overview</h4>
                    <p className="text-sm leading-6 text-gray-800 dark:text-gray-200 whitespace-pre-line">{room.feedback.feedback}</p>
                  </div>
                )}
                ...
                {!room.feedback.feedback && !room.feedback.summary && (
                  <p className="text-sm text-gray-500">No feedback generated yet.</p>
                )}
              </div>
            ) : (
              <p className="text-sm text-gray-500">No feedback generated yet.</p>
